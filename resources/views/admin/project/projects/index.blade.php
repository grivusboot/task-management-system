...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('project.admin.projects.create') }}" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('project.admin.projects.edit', $project) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                            <form method="POST" action="{{ route('project.admin.projects.delete', $project) }}" class="inline">
                                @csrf
                                @method('DELETE')
